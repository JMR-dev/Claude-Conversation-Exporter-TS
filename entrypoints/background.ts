...
import { defineBackground as wxtDefineBackground } from 'wxt/utils/define-background';
import type { ExtensionMessage } from '../src/types';

export default wxtDefineBackground(() => {
  console.log('Claude Conversation Exporter background script loaded');
  ...
  browser.runtime.onMessage.addListener(
    (request: ExtensionMessage, _sender: browser.runtime.MessageSender) => {
